...
local window1 = library:Window("FE Szkriptek")
local window2 = library:Window("LocalPlayer")
local window3 = library:Window("Autó beállítások")
local window5 = library:Window("Terület Teleportok")
local window6 = library:Window("Fegyver Szkriptek")

window3:Slider("Autó magasásga",3,100,3, function(valuee11)
    local a = require(game.Workspace.ObjectSelection[game.Players.LocalPlayer.Name.." Autója"].Settings)
a.Height = valuee11
end)



window3:Slider("Autó Kamera Zoomolás",1,50,1, function(value22)
        local a = require(game.Workspace.ObjectSelection[game.Players.LocalPlayer.Name.." Autója"].Settings)
a.CameraOffset = value22
end)


window3:Slider("Autó maximum sebessége",20,1000,1, function(value3143)
local a = require(game.Workspace.ObjectSelection[game.Players.LocalPlayer.Name.." Autója"].Settings)
a.MaxSpeed = value3143
end)

window3:Slider("Autó fékerő",5,5000,5, function(value4qc4)
local a = require(game.Workspace.ObjectSelection[game.Players.LocalPlayer.Name.." Autója"].Settings)
a.BrakeForce = value4qc4
end)

window3:Toggle("Lebegő mód",false,function(ogwe)
    getgenv().trinkhhnn4nets = ogwe
if getgenv().trinkhhnn4nets then
game.Workspace.ObjectSelection[game.Players.LocalPlayer.Name.." Autója"].CarChassis.HoverMode.Value = true
else
game.Workspace.ObjectSelection[game.Players.LocalPlayer.Name.." Autója"].CarChassis.HoverMode.Value = false
end
end)

window2:Toggle("Vizen járás",false,function(ddq)
...
window3:Button("Végtelen Nitró [józsi]",function()
    game:GetService("RunService").RenderStepped:Connect(function()
if workspace.ObjectSelection:FindFirstChild(game.Players.LocalPlayer.Name.." Autója") then
pcall(function()workspace.ObjectSelection[game.Players.LocalPlayer.Name.." Autója"].CarChassis.Boost.Value = 20;end)
end
end)
end)

window3:Label("FE Autó színek", Color3.fromRGB(127, 143, 166))

window3:Toggle("Szivárvány ablak [EWW idk miert raktam be]",false,function(e6hhhhh)
...
Title = "szivárvány ablak",     
Text = "Ehhez a szkripthez minden ablakszínnek működnie kell",
Duration = 7, })
end)

window3:Toggle("Szivárvány gumi",false,function(e6hhhh)
...
game:GetService("ReplicatedStorage").RemoteFunction:InvokeServer("EquipItem","RC20")
            ...
            game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "szivárvány kerék geci",     
Text = "Ehhez a szkripthez minden kerékszínnek működnie kell",
Duration = 7, })
end)
    
    
window3:Toggle("Szivárvány szpójler",false,function(e6uohhhhh)
...
game:GetService("ReplicatedStorage").RemoteFunction:InvokeServer("EquipItem","SPC20")
    wait(.08)
            ...
            game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "Szivárvnáy szpójler",     
Text = "Ehhez a szkripthez minden szpójlerszínnek működnie kell",
Duration = 7, })
end)


window3:Box("Tábla átvnevezése",function(ew60we,geyyu)
    if geyyu then
...
window1:Button("Hozd magaddal rögzítetlen téglákat [E]",function()
...
spawn(function()
    ...
    game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "Hozd magaddal rögzítetlen téglákat",     
Text = "Kocsikon működik csak bro, te exploitod ezt supportálja 'sethiddenproperty'",
Duration = 15, })
end)

window1:Button("FE Gravity eszköz",function()
loadstring(game:HttpGet("https://ghostbin.co/paste/b93p/raw", true))()
game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "FE Gravity eszköz",     
Text = "autokon megy csak",
Duration = 4, })
end)


window1:Label("Egyéb Szkriptek", Color3.fromRGB(127, 143, 166))


window6:Button("Végtelen Fegyver lőszer",function()
    game:GetService("RunService").RenderStepped:Connect(function()
...
window6:Label("10x Fegyó sebzés", Color3.fromRGB(127, 143, 166))
...
window6:Label("Gamepassos fegyók", Color3.fromRGB(127, 143, 166))
...
window5:Button("Repülő",function()
...
window5:Label("Játékos teleport", Color3.fromRGB(127, 143, 166))




window2:Toggle("gyors gyorsaság",false,function(val)
...
window2:Slider("ugrássi erősség",50,300,20, function(valaadue)
...
window2:Button("rejoingec", function()
    game:GetService("TeleportService"):Teleport(game.PlaceId)
end)


window2:Button("Reset kari",function()
      game.Players.LocalPlayer.Character.Head:Remove()
end)


window2:Label("FE Szkriptek #2", Color3.fromRGB(127, 143, 166))

window2:Toggle("Láthatatlan more",false,function(atakabqeq)
...
window2:Button("Loopolás nevek eltávolátisa",function()
    game:GetService("RunService").RenderStepped:Connect(function()
game.Players.LocalPlayer.Character.NameTag:Destroy()
end)
    game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "Figyelem",     
Text = "Te neved már nem látszódik",
Duration = 15, })
end)

window2:Button("összes kocsi duda szpemmelése",function()
for i,v in pairs(game.Workspace.ObjectSelection:GetDescendants()) do
if v:IsA("Sound") then 
v:Play()
end
...
window2:Label("Magadnak adás", Color3.fromRGB(127, 143, 166))
...
window2:Button("Összes gamepass adása",function()
game.ReplicatedStorage.Event:FireServer("Dialogue",{{Text="Car Radio, Emotes,Mobile Shop, oda lett adva",Delay=2}})
wait()
...
window2:Button("Szerezd meg a Deathrayt",function()
    if game.ReplicatedStorage.HeistStatus.Pyramid.Locked.Value == true then
            game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "Szerezd meg a Deathrayt Szkriptet moreee",     
Text = "várd meg a piramis geci újranyisson",
Duration = 10, })
else
local _speed=1999
function tp(...)
...
window1:Button("összes játékosoknak glider",function()
for i,v in pairs(game.Players:GetChildren()) do
local args = {
    [1] = "Glider",
...
window1:Button("glider eltüntetés mindenkiről",function()
for i,v in pairs(game.Players:GetChildren()) do
local args = {
    [1] = "Glider",
    [2] = v.Character.Parachute.Handle,
...
window1:Button("szerver crash bro",function()
   if game.Players.LocalPlayer.Backpack:FindFirstChild("Shotgun") == nil then
    game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "figyelem",     
Text = "Először kell egy shotgun bro",
Duration = 7, })
else
local plr = game.Players.LocalPlayer
...
game:GetService("ReplicatedStorage").Event:FireServer("ShootShotgun", workspace[plr.Name], Vector3.new(0, 0, 0), "Shotgun", "inf", "inf", "inf")
           ...
           game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "Crash szkript",     
Text = "szerver crashelve lett",
Duration = 7, })
end
end)

window1:Label("Isten mód szkriptek he", Color3.fromRGB(127, 143, 166))

window1:Toggle("Magadnak adás",false,function(cwe)
...
window1:Toggle("eGÉSZ SZERÓNAK",false,function(cqwtrt)
...
window1:Toggle("XP Farm [Védett terület more]",false,function(gtwe84)
...
window1:Label("FE Brick Szpamelés", Color3.fromRGB(127, 143, 166))

window1:Button("+ Brick Szpem eszköz",function()
        game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "",     
Text = "várd meg amig a üzenet betölt",
Duration = 15, })
...
workspace.ObjectSelection.Treat.Treat.Treat.Event:FireServer()
    game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "Brick Szpem szkript betölt",     
Text = "Betöltve most dobd el a szutykot",
Duration = 15, })
end)



window1:Button("eldobás Brick",function()
        if game.Players.LocalPlayer.Backpack:FindFirstChild("Treat") == nil then
           game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "figyelem",     
Text = "kattints először a gecis oda adáshoz more",
Duration = 15, })
else
    wait(1)
        local tool = "Treat"
...
game:GetService("ReplicatedStorage").Event:FireServer("ThrowTreat",Vector3.new(1990, 26, 435))
    ...
    game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "figyelem",     
Text = "először add meg mennyit akarsz gec és nyomd meg a T gombot",
Duration = 15, })
for i =1,100 do
...
window1:Box("Brick mennyiség", function(bwhassee, focusloskamereeet)
    if focusloskamereeet then
       bbgw147we = bwhassee
end
    game:GetService("StarterGu-i"):SetCore("SendNotification",{     
Title = "figyelem",     
Text = "Növelje a tégla mennyiségét a szerver összeomlásához, ha akarja!",
Duration = 15, })
end)

window1:Label("Grenade Szkript", Color3.fromRGB(127, 143, 166))

window1:Button("Grenade Szpemm",function()
    if game.Players.LocalPlayer.Backpack:FindFirstChild("Grenade") == nil then
           game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "Figyelem",     
Text = "Gránát kell a raktárában",
Duration = 15, })
else
    wait(1)
        local tool = "Grenade"
...
game:GetService("ReplicatedStorage").Event:FireServer("ThrowGrenade",Vector3.new(-1626.83398, 43.1575661, 689.200378))
           ...
           game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "Figyelem",     
Text = "Bomba mennyiség hozzáadása a szkriptmunkához, nyomja meg az F gombot a bomba eldobásához",
Duration = 15, })
for i = 1,100 do
...
window1:Box("Bomba mennyiség", function(bwee, fochhusloseeet)
...
window1:Label("1 idő rablás szkriptekgec", Color3.fromRGB(127, 143, 166))

window1:Button("Bypass TP",function()
            game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "Bypass TP",     
Text = "játékosok mostmár nem látnak téged",
Duration = 15, })
...
window1:Button("Kicsi rablás",function()
wait(2)
         game.Players.LocalPlayer.Character.HumanoidRootPart.Parent = nil
for i,v in pairs(getnilinstances()) do 
   if v.Name == "HumanoidRootPart" then
...
local thing = "thing"
local busy_str = "%s nem rabolható ki, mert elfoglalt %s-szal"
local not_finished = "Más dolgokat nem lehet kirabolni, mert a %s rablás még nem fejeződött be"
...
window1:Button("Bank",function()
    if game.ReplicatedStorage.HeistStatus.Bank.Locked.Value == true then
        game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "Bank Rablás",     
Text = "Várd meg amig a bank kinyit",
Duration = 15, })
else
    local function Bank()
              local _speed=1000
...
window1:Button("Plane",function()
    if game.Workspace.CargoPlane.Plane == nil then
        game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "Repülő rablás",     
Text = "Várd meg amig a repülő megérkezik",
Duration = 15, })
    else
    local _speed=1000
function tp(...)
...
if game.ReplicatedStorage.HeistStatus.Pyramid.Locked.Value == true then
            game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "Piramis rablás",     
Text = "Várd meg amig a piramis kinyit",
Duration = 10, })
else
local _speed=1999
function tp(...)
...
window1:Button("Hajó",function()
    if game.Workspace.Ship.Boat.Vault == nil then
        game:GetService("StarterGui"):SetCore("SendNotification",{     
Title = "Hajó rablás",     
Text = "Várd meg amig a hajót tudjad rabolni",
Duration = 15, })
else
                 local _speed=2000
function tp(...)
